...
| **Ocupação** | Estudante de Direito no Centro de Ensino Unificado de Brasília (CEUB) |
| **Dados Demográficos** | 27 anos.<br/>Casada.<br/>Sexo Feminino.<br/>Mora com o marido em um loft. |
| **Objetivos e Tarefas** | Fernanda é procrastinadora, porém tenta equilibrar seu tempo entre estágio e a faculdade. O seu grande objetivo é se tornar juíza federal.<br/><br/>Passa seu tempo útil:<br/>- Cumprindo suas obrigações para com o curso de direito (atividades, trabalhos e estudando para provas).<br/>- Exercendo suas funções de estagiária no escritório. |
| **Ambiente** | Ela só volta para casa para dormir, parte do dia ela fica no campus e a outra parte no escritório de advocacia onde faz estágio. Em casa, quando pode, ela gosta de assistir aos cortes da live do Casé e também aos melhores momentos das partidas do Vasco da Gama. |
...
| **Ocupação** | Divulgador científico na área de física |
| **Dados Demográficos** | 29 anos.<br/>Solteiro.<br/>Sexo Masculino.<br/>Possui 3 gatos. |
| **Objetivos e Tarefas** | Roberto apesar de viver praticamente sozinho, é sempre ativo buscando atividades para fazer e projetos para iniciar.<br/><br/>Passa seu tempo útil:<br/>- Estudando diversos assuntos de sua área para que possa realizar seu trabalho como divulgador científico.<br/>- Organizando a casa. |
| **Ambiente** | Passa a maior parte do tempo em casa, mas sai para fazer compras de comida e itens para a casa. Quando tem tempo, grava vídeos dos seus estudos mais atuais para divulgar na internet e compartilhar seu conhecimento, tentando entusiasmar as pessoas para sua área de pesquisa. |
...
| **Dados Demográficos** | 36 anos.<br/>Casado.<br/>Sexo Masculino.<br/>Mora com a esposa em uma mansão. |
| **Objetivos e Tarefas** | Roger é ativo e possui uma mente inquieta, busca sempre começar um novo projeto que vem a sua cabeça, fazendo com que fique sempre ocupado tendo que estudar diversas tecnologias para desenvolver seus protótipos.<br/><br/>Passa seu tempo útil:<br/>- Pesquisando sobre guias e ilustrações de peças e tecnologias que pretende utilizar em seus projetos.<br/>- Exercendo suas atividades como engenheiro mecânico em uma indústria. |
...
|     |    |
| :-: | :- |
| **Foto** | <img src="https://raw.githubusercontent.com/Requisitos-de-Software/2022.1-Grupo-03/main/docs/media/personas/antipersona.jpg" width="128" height="128"/> |
| **Nome** | Maria Cláudia |
| **Ocupação** | Professora aposentada |
| **Dados Demográficos** | 70 anos.<br/>Viúva.<br/>Sexo Feminio.<br/>Mora sozinha em um apartamento de 2 quartos com 1 gato. |
| **Objetivos e Tarefas** | Após viver uma vida lecionando para estudantes do Ensino Fundamental, Maria agora pensa em descansar. É uma mulher caseira e calma.<br/><br/>Passa seu tempo útil:<br/>- Fazendo palavras cruzadas.<br/>- Caminhando no parque verde próximo a sua moradia. |
| **Ambiente** | Maria Cláudia é pontual com os jornais e novelas que passam na TV. Seu melhor momento do dia é quando se reúne com seu gato, come sua janta na poltrona e assiste algum programa na TV. Quase nunca usa o celular, apenas para ligar para a filha que mora em outro estado. |
| **Expectativas** | Ela não busca nenhuma utilidade em aplicativos de celulares, principalmente aqueles que são de vídeos, já que tem todos os programas de todos os temas que precisa na televisão. |
| **Frase** | “Na minha época não era assim...". |
...
| ------ | ---- | --------- | --------- | ----------- |
| 1.0    | 04/07/2022 | Criação da primeira versão do documento com as primeiras personas do elenco de personas e anti-persona. | <a href="https://github.com/victorleaoo" target="_blank">@victorleaoo</a>, <a href="https://github.com/owhenrique" target="_blank">@owhenrique</a>, <a href="https://github.com/B3holder2" target="_blank">@B3holder2</a>, <a href="https://github.com/CDGodoy" target="_blank">@CDGodoy</a> | <a href="https://github.com/lramon2001" target="_blank">@lramon2001</a>, <a href="https://github.com/Alef012" target="_blank">@Alef012</a> |
